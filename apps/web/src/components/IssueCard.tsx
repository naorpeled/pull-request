...
export function IssueCard({ issue }: IssueCardProps) {
  ...
  return (
    <a
      ...
      className="block bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow p-4 border border-gray-200 hover:border-indigo-400"
    >
      {/* Repository Info */}
      <div className="flex items-start justify-between mb-2">
        ...
        <div className="flex items-center gap-1 text-yellow-500 ml-2">
          ...
          <span className="text-xs font-medium">{Issue.issue_repo.repo_stars}</span>
        </div>
      </div>
